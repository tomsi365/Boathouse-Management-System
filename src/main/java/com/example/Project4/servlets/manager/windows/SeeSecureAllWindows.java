...
@WebServlet(name = "seeSecureAllWindows", urlPatterns = "/seeSecureAllWindows")
public class SeeSecureAllWindows extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if(request.getSession(false)==null){
            ...
            try {
                ...
                outObject=this.engine.getSecureAllWindows();
