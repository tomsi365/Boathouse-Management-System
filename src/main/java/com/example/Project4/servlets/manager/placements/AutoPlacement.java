package com.example.Project4.servlets.manager.placements;
...
@WebServlet(name = "autoPlacement", urlPatterns = "/autoPlacement")
public class AutoPlacement extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if(request.getSession(false)==null){
            ...
            try {
                ...
                int regId=Integer.parseInt(inObject);
                int serialNumber=0;
                String matchedBoats[][]=this.engine.getMatchedBoats(regId);
                if(matchedBoats.length>0){
                    serialNumber= Integer.parseInt(matchedBoats[0][0]);
                    this.engine.addPlacement(regId,serialNumber);
                    outObject="placed";
                }
                else{
                    outObject="Matching boat failure !";
                }
