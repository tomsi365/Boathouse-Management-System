...
@WebServlet(name = "seeSecureAllMembers", urlPatterns = "/seeSecureAllMembers")
public class SeeSecureAllMembers extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if(request.getSession(false)==null){
            ...
            try {
                ...
                outObject=this.engine.getSecureAllMembers();
