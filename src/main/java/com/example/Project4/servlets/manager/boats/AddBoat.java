...
@WebServlet(name = "addBoat", urlPatterns = "/addBoat")
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if(request.getSession(false)==null){
            ...
            try {
                ...
                this.engine.addBoat(inObject.name,inObject.type,inObject.isWideBoat,inObject.isSeaBoat,inObject.isCoxswain,inObject.isDisabled);
