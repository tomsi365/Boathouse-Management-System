    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if(request.getSession(false)==null){
            ...
            try {
                ...
                this.engine.addMember(inObject.name,inObject.age,inObject.level,inObject.expiryDate,inObject.phone,inObject.email,inObject.password,inObject.isManager);
