...
@WebServlet(name = "seeAllCombinedNotifications", urlPatterns = "/seeAllCombinedNotifications")
public class SeeAllCombinedNotifications extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if(request.getSession(false)==null){
            ...
            try {
                ...
                outObject=this.engine.getAllCombinedNotifications();
                this.engine.read();
