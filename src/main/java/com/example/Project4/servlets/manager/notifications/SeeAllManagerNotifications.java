...
@WebServlet(name = "seeAllManagerNotifications", urlPatterns = "/seeAllManagerNotifications")
public class SeeAllManagerNotifications extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if(request.getSession(false)==null){
            ...
            try {
                ...
                outObject=this.engine.getAllManagerNotifications();
