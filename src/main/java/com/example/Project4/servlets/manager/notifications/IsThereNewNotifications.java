...
@WebServlet(name = "isThereNewNotifications", urlPatterns = "/isThereNewNotifications")
public class IsThereNewNotifications extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if(request.getSession(false)==null){
            ...
            try {
                ...
                outObject= String.valueOf(this.engine.isThereNewNotifications());
