...
@WebServlet(name = "seeAllRegsTypes", urlPatterns = "/seeAllRegsTypes")
public class SeeAllRegsTypes extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if(request.getSession(false)==null){
            ...
            try {
                ...
                outObject=this.engine.getAllRegsTypes(Integer.parseInt(inObject));
