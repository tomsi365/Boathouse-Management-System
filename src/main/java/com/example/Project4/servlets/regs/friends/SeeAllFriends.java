...
@WebServlet(name = "seeAllFriends", urlPatterns = "/seeAllFriends")
public class SeeAllFriends extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if(request.getSession(false)==null){
            ...
            try {
                ...
                outObject=this.engine.getAllFriends(Integer.parseInt(inObject));
