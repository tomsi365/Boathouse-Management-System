...
@WebServlet(name = "unitRegs", urlPatterns = "/unitRegs")
public class UnitRegs extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        int[] inObject=gson.fromJson(inJson, int[].class);
        ...
        if(request.getSession(false)==null){
            ...
            try {
                ...
                this.engine.unitRegistrations(inObject[0],inObject[1]);
